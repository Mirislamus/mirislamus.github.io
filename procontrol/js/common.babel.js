...
document.addEventListener('DOMContentLoaded', function () {
  ...
  }
  {
    ...
    var mobileNav = document.querySelector('.page-header__right');
    ...
    var Mmodal = /*#__PURE__*/function () {
      function Mmodal() {
        ...
        var _options$open = options.open,
            ...
            close = _options$close === void 0 ? '.m-modal__close' : _options$close;
        this.open = open;
        this.modal = modal;
        this.close = close;
        this.init();
...
$(document).ready(function () {
  $('.work-slider').each(function () {
    var workSlider = new Swiper($(this), {
      spaceBetween: 48,
      pagination: {
  ...
  var sertificatesSlider = new Swiper($('.sertificate-slider .swiper-container'), {
    spaceBetween: 22,
    pagination: {
      el: '.swiper-pagination',
      clickable: true
  ...
  $('.object').on('click', function () {
    if ($(this).hasClass('object--active')) {
      ...
      $(this).css('padding-bottom', "".concat(objHeight + 21, "px"));
