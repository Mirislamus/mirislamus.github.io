jQuery(function ($) {
  ...
  $('.more').on('click', function (e) {
    ...
    $('.portfolio_row-item.hidden .bigslider').slick('setPosition');
    $('.portfolio_row-item.hidden .navslider').slick('setPosition');
  });
  $('a[data-toggle="list"]').on('shown.bs.tab', function (e) {
    e.target;
    e.relatedTarget;
    $('.portfolio_row-item .bigslider').slick('setPosition');
    $('.portfolio_row-item .navslider').slick('setPosition');
