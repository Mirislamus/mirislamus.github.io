...
$(document).ready((function(){new SmoothScroll('a[href*="#"]',{speed:300,speedAsDuration:!1,topOnEmptyHash:!1,easing:"linear"});function e(){$(window).width()<768&&($(".header").hasClass("header--open")?$("body").css("overflow","hidden"):$("body").css("overflow",""))}$('.hamburger, .header a[href*="#"]').on("click",()=>{$(".header").toggleClass("header--open"),e()}),$(document).on("click",o=>{o.target.closest(".header")||($(".header").removeClass("header--open"),e())});var o=$(".hero");o.outerHeight(),/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&o.addClass("hero--mobile")}));